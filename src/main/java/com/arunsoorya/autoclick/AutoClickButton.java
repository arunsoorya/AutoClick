package com.arunsoorya.autoclick;
...
/**
 * Created by arun kumar on 12/5/2015.
 */
public class AutoClickButton extends Button {
    ...
    public AutoClickButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AutoClickButton(Context context, AttributeSet attrs, int defStyle) {
